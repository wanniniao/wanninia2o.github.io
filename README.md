...
<title>网址导航-www.bilibili.com</title>
...
<body>
    <div class="container" id="container">
        <aside class="left-bar" id="leftBar">
            <div class="title">
                <p align="center" class="STYLE1">网址大全</p>
            </div>
            <nav class="nav">
                <div class="item active"><a href=""><i class="iconfont icon-daohang2"></i>网址导航</a><i class="line"></i></div>
                <ul class="nav-item" id="navItem">
                    <li><a href="#bbs" class="active"><i class="iconfont icon-shequ"></i>视频网站</a><a name="视频网"></a><a href="#bbs" class="active">                       </a><a href="#sill">社交软件 </a><a href="#docs">开发文档 </a><a href="#tools">实用工具 </a><a href="#design">设计资源 </a><a href="#study">学无止境 </a><a href="#operation">网络运营 </a><a href="https://github.com/geekape/geek-navigation">源码下载</a></li>
                    <li>
                      <p>&nbsp;</p>
                      <p>&nbsp;</p>
                      </li>
        ...
        <div class="box"><div class="sub-category"><div></div>
                    </div>
                    <div>
                ...
                <footer class="footer">
                    <div class="copyright">
                        <div>
                            Copyright © 2018- 2050
                            <a href="http://www.cheat8.com">奇特吧</a>
                        </div>
                    </div>
                </footer>
        </section>
        ...
        <p>&nbsp;</p>
        <table width="843" height="97" border="1">
          <tr>
            <td width="165"><a href="www.bilibili.com">bilibili</a></td>
            <td width="224"><a href="www.yuotube.com">youtuobe</a></td>
            <td width="152"><a href="www.pornhub.com">pornhub</a></td>
            <td width="132">&nbsp;</td>
            <td width="136">&nbsp;</td>
          </tr>
          <tr>
